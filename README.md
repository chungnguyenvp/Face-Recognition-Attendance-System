...
- Kiểm tra và vô hiệu hóa liên kết tài khoản–sinh viên không còn hợp lệ.
...
- Thu hồi session khi logout, đổi mật khẩu, khóa/xóa tài khoản hoặc phát hiện liên kết sinh viên không hợp lệ.
...
### Tài khoản sinh viên báo chưa liên kết hồ sơ

Tài khoản chưa được liên kết với một hồ sơ sinh viên hợp lệ. Admin cần chọn lại hồ sơ đúng và kích hoạt tài khoản nếu tài khoản đang bị khóa.

### Migration báo liên kết tài khoản bị trùng
